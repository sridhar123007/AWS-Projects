...
myAWSIoTMQTTClient = AWSIoTMQTTClient("IoTcore1")
...
myAWSIoTMQTTClient.subscribe("Sridhar123", 1, customCallback)
time.sleep(2)
...
while True:
        ...
        JSONPayload = {'id':date,'sno': 1,'temperature': 30, 'humidity': 50}
