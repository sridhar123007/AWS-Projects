...
class VideoDetect:
    jobId = ''
    rek = boto3.client('rekognition', region, aws_access_key_id = access_key_id, aws_secret_access_key = secret_access_key)
    queueUrl = 'https://sqs.us-east-2.amazonaws.com/858626447215/recognition-video-Queue'
    roleArn = 'arn:aws:iam::858626447215:user/hello'
    topicArn = 'arn:aws:sns:us-east-2:858626447215:sns-video-recognition'
